...
class Booking
{
    ...
    //Fonction qui ajoute la date de création de la réservation et son montant automatiquement comme ça n'est pas fait par formulaire

    /**
     * Callback appelé à chaque fois qu'on créé une réservation ou qu'on la modifie
     * 
     * @ORM\PrePersist
     * @ORM\PreUpdate
     *
    ...
    public function isBookableDates(){
        ...
        //Il faut connaître les dates déjà prises pour l'annonce
        $notAvailableDays = $this->ad->getNotAvailableDays();
        //Il faut comparer les dates choisies avec celles déjà prises
        ...
        foreach ($days as $day) {
            //La méthode array_search permet de comparer 2 tableaux
