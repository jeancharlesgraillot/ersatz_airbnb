...
// Permet de valider l'unicité d'une entité et d'éviter les doublons
...
class Ad
{
    ...
    public function getCommentFromAuthor(User $author){
        //Parmis les commentaires sur l'annonce, y en a t-il un provenant de l'auteur de la fonction
    ...
    /**
     * Permet de calculer la somme des notations pour en déduire une moyenne
     *
     * @return float
     */
    ...
    /**
     * Permet d'obtenir un tableau des jours non disponibles pour l'annonce
     *
    ...
    public function getNotAvailableDays(){
        ...
        foreach ($this->bookings as $booking) {
            ...
            //getTimeStamp est une méthode s'appliquant sur les objets DateTime
            $resultat = range(
            ...
            //méthode arrayMap pour transformer le tableau range en un tableau de jours
            $days = array_map(function($dayTimeStamp){
                return new \DateTime(date('Y-m-d', $dayTimeStamp));
            }, $resultat);

            //On fusionne le tableau des jours non dispo pour chaque annonce avec le tableau global
