...
{   
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('coverImage', UrlType::class, $this->getConfiguration("URL de l'image principale", "Donnez l'adresse de l'image qui vous fait vraiment envie"))
            ...
            // Ajout d'un champ images de type collection pour mettre en place un sous formulaire qui peut se répéter à la demande
            ->add('images', CollectionType::class, [
                // Sous formulaire de type ImageType créé pour l'occasion
